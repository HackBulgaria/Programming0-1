...
## Задача 4 - Изпринтете цифрите на 1 число, започвайки от последната
...
## Задача 5 - Сумата на цифрите на 1 число
...
## Задача 6 - Сумата на цифрите на всички числа между N и M
...
## Задача 8 - Най-голямото и най-малкото число, съставено от 3 цифри.
...
## Задача 10 - Дали число е палиндром?
