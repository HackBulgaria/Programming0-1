...
| 1 | Понеделник - 02.02 | [Задачите се намират по своите папки](https://github.com/HackBulgaria/Programming0-1/tree/master/week1) | [Types. IO. Booleans & If statement](http://slides.com/hackbulgaria/types-io-booleans-if-clause) | [Типове, оператори и типова система в Python.](https://www.youtube.com/watch?v=kvyuTZF12a0), [Вход и Изход. Взимане на вход от потребителя.](https://www.youtube.com/watch?v=5jySIMqwSl4), [Булеви променливи и if statement.](https://www.youtube.com/watch?v=jcZTvze4SO0)  |
